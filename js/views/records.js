                ...
                ${records.map(record => `
                  <article class="record-card">
                    ...
                    <div class="record-grid">
                      ...
                      <div class="mini-card">
                        <span>保證金</span>
                        <strong>${BS.UI.number(record.margin, 4)} U</strong>
                      </div>

                      <div class="mini-card">
                        <span>保證金%</span>
                        <strong>${BS.UI.number(record.marginPct, 2)}%</strong>
                      </div>

                      <div class="mini-card">
                        <span>最大虧損</span>
                        <strong>${BS.UI.number(record.maxLoss, 4)} U</strong>
                      </div>
                    </div>
                  </article>
                `).join("")}
